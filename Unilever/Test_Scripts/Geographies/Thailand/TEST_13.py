...
log_filename = f"Unilever_Thailand_TEST_13_{today}_{timestamp_str}.log"
...
GT_df = Thailand_Question_13.Que_13()
print("Test Function Output:\n", GT_df)

# Step 7: Log the output explicitly

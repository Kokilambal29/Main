...
log_filename = f"Unilever_Thailand_TEST_17_{today}_{timestamp_str}.log"
...
GT_df = Thailand_Question_17.Que_17()
print("Test Function Output:\n", GT_df)

logging.info(f"Test Function Output:\n{GT_df.to_string(index=False)}")

# STEP-2 placeholder (e.g., comparisons if needed)
